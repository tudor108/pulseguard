  ...
  head: () => ({
    meta: [
      { title: "Tendinte Risc - PulseGuard AI" },
      {
        name: "description",
        content:
          "Tendinte ale semnalelor operationale si descompunere de risc pe ultimele 30 zile.",
      },
    ...
    <AppShell>
      <header className="mb-6 animate-fade-up">
        <div className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground inline-flex items-center gap-2">
          <TrendingUp className="h-3 w-3" /> Tendinte Risc
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        <div className="glass luminous-border rounded-2xl p-5 animate-fade-up">
          <h2 className="text-sm font-semibold mb-2">
            Volum de lucru si ore suplimentare (30 zile)
          </h2>

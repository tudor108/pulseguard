...
export function buildForecast(days = 30, forecastDays = 14): ForecastPoint[] {
  ...
  for (let i = 0; i < total; i++) {
    ...
    out.push({
      ...
      interventionUrgency: Math.min(
        99,
        Math.round(38 + Math.sin(t / 5.5) * 6 + t * 0.7 + drift * 1.1),
      ),
      forecast: isForecast,
    });
  }
...
export const recommendations: Recommendation[] = [
  {
    id: "r1",
    title: "Adauga 2 asistenti pe tura de noapte ATI pentru 7 zile",
    detail:
      "Prognoza arata ca indicele de oboseala trece de 75 pana in ziua 4. Intareste rotatia de noapte ca sa reduci presiunea pe personalul expus.",
    impact: "ridicat",
    eta: "Tura urmatoare",
    department: "ATI",
  },
  {
    id: "r2",
    title: "Limiteaza orele suplimentare UPU la 8 ore pe saptamana",
    detail:
      "Orele suplimentare sustinute peste 12 ore sunt corelate cu risc mai mare de incidente in ultimele 14 zile.",
    impact: "ridicat",
    eta: "Saptamana aceasta",
    department: "UPU",
  },
  {
    id: "r3",
    title: "Programeaza verificari de stare pentru echipa Oncologie",
    detail: "Scorul de stres a crescut cu 0.9 puncte; recomanda discutii individuale de 30 minute.",
    impact: "mediu",
    eta: "In 5 zile",
  ...
  {
    id: "r4",
    title: "Redistribuie 4 pacienti din Chirurgie catre rezerva Maternitate",
    detail:
      "Maternitatea are ocupare 68%, deci exista capacitate pentru a reduce presiunea din Chirurgie.",
    impact: "mediu",
    eta: "48 ore",
  ...
  {
    id: "r5",
    title: "Activeaza protocolul de micro-pauze in Psihiatrie",
    detail:
      "Indicele de oboseala estimat ajunge la 72 in 6 zile. Activeaza pauze protejate de 15 minute.",
    impact: "scazut",
    eta: "Urmatoarele 72h",
...
export const liveSignals: IncidentSignal[] = [
  {
    id: "s1",
    time: "acum 2 min",
    message: "Orele suplimentare ATI pe tura de noapte au crescut cu 14%",
    level: "critical",
    dept: "ATI",
  },
  {
    id: "s2",
    time: "acum 11 min",
    message: "Raport pacienti/personal UPU la 5.8, tinta 4.5",
    level: "warn",
    dept: "UPU",
  },
  {
    id: "s3",
    time: "acum 26 min",
    message: "Sondajul de stres Oncologie a fost trimis (n=18)",
    level: "info",
    dept: "Oncologie",
  },
  {
    id: "s4",
    time: "acum 48 min",
    message: "Indicele de oboseala Pediatrie este in scadere (-3.1)",
    level: "info",
    dept: "Pediatrie",
  },
  {
    id: "s5",
    time: "acum 1h",
    message: "Concedii medicale Psihiatrie +2 fata de baza pe 7 zile",
    level: "warn",
    dept: "Psihiatrie",
  },
];
...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    risk: 62,
    description:
      "Scorul de stres a crescut cu 0.9 puncte; 4 persoane au nevoie de verificare de stare.",

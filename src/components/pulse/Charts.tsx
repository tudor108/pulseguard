  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <ComposedChart data={enriched} margin={{ top: 10, right: 12, left: -10, bottom: 0 }}>
        ...
        <Area
          type="monotone"
          dataKey="workloadPressure"
          name="Presiune de lucru"
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <LineChart data={data} margin={{ top: 10, right: 12, left: -10, bottom: 0 }}>
        ...
        <Tooltip content={<TooltipBox />} />
        {splitDate && (
          <ReferenceLine x={splitDate} stroke="oklch(0.97 0.01 230 / 0.25)" strokeDasharray="4 4" />
        )}
        <Line
          type="monotone"
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={enriched} margin={{ top: 10, right: 12, left: -10, bottom: 0 }}>
        ...
        <Line
          type="monotone"
          dataKey="patientRatioScaled"
          name="Raport pacienti/personal"
          stroke="oklch(0.82 0.18 210)"
          strokeWidth={2}
          dot={false}
          isAnimationActive
        ...
        <Line
          type="monotone"
          dataKey="sickLeave"
          name="Evenimente concediu medical"
          stroke="oklch(0.68 0.22 20)"
          strokeWidth={2}
          dot={false}
          isAnimationActive
        ...
        <Line
          type="monotone"
          dataKey="stressScoreScaled"
          name="Scor sondaj stres"
          stroke="oklch(0.78 0.16 165)"
          strokeWidth={2}
          dot={false}
          isAnimationActive
